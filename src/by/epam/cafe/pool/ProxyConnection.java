...
public class ProxyConnection implements Connection {
    ...
    //пакетная видимость. для предотвращения создания объекта не из пакета
    ...
    //метод возвращает коннекшен в пул.
    @Override
    public void close() throws SQLException {
        ConnectionPool.getInstance().releaseConnection(this);
    }

    //реально закрыть коннекшен можно только из пакета (метод вызывается в ConnectionPool)
