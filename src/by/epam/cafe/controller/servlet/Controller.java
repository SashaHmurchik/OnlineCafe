package by.epam.cafe.controller.servlet;
...
public class Controller extends HttpServlet{
    ...
    private void processRequest(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        ...
        /*if (request.getSession().getAttribute(SessionAtr.LOCALE) == null) {
            request.getSession().setAttribute(SessionAtr.LOCALE, "EN");
        }*/
        ...
        if (page != null) {
            ...
            request.getSession().setAttribute("nullPage",
                    MessageManager.valueOf(locale).getMessage("message.nullpage"));
