...
public interface UserDao {
    ...
    boolean updateUser(RequestContent content) throws DAOException;
    boolean updateUserPassword(String eMail, String password) throws DAOException;
    String getPhoneByEmail(String eMail) throws DAOException;
    boolean updateLoyaltyPointByUserId(Integer loyaltyPoint, Integer userId) throws DAOException;
}
