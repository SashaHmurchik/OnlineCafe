...
<div class="container theme-showcase" role="main">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div>
                <h1><fmt:message key="label.account.edituser" bundle="${rb}"/></h1>
            </div>
            <div class="control-group">
                <div class="controls">
                    <a class="btn btn-success" href="/jsp/client/changepass.jsp"><fmt:message key="label.account.changepass.changepass" bundle="${rb}"/></a>
                </div>
            </div>
